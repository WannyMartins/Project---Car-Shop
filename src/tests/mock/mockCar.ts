...
const carMockUpdateInvalido: any = {
  model: "ford Ka",
  year: "2000",
  color: "blue",
  buyValue: "25000",
...
export {carMock, carMockWithId, carMockAllDb, idValido, carMockUpdate, carMockUpdateWithId, carMockUpdateBefore, carMockUpdateInvalido}